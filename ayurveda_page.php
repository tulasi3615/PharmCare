    ...
    <div class="header" style="transform:translateY(-10px);">
      ...
      <div id="display"></div>   
        ...
        <div >
          ...
          <center>
          <div class="presint" style="background-color: rgb(127,255,212);border-top:3px solid grey;border-bottom:3px solid grey;padding:18px;width:100%;height:300px;">
        ...
        <div style="overflow: hidden; position: absolute;transform: translateY(-18px);">
            
          
            <div class="header" style="color: white;padding: 5px;font-size: 30px;background-color: rgb(53, 52, 52);"><div style="transform: translateX(45%);"><b>AYURVEDA</b></div></div>
            ...
            <div class="col-xs-12 col-md-6">
              ...
              <div class="prod-info-main prod-wrap clearfix" style="border: 2px solid rgb(53, 52, 52);">
                <div class="row">
                    ...
                    <div class="product-deatil">
                        <form action="buy_now.php" method="post">
                    <input type="hidden" name="product_name" value="immunity_booster_capsules"/>
